...
//import DAL.defult.Dal.DBHandler;
...
public abstract class HRDAO {
    ...
    public static final String url = "jdbc:sqlite:Database/Delivery_Data.db";
    DateTimeFormatter formatters = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    DateTimeFormatter formatter_2  = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
    DateTimeFormatter formatter_3  = DateTimeFormatter.ofPattern("HH:mm");
    //constructor
    public HRDAO(String tableName) {
