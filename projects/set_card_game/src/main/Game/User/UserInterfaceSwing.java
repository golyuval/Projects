...
import Maneger.InputManager;
import Maneger.WindowManager;
import Admin.Config;
import Roles.Player;
    ...
    private class GamePanel extends JLayeredPane {
        ...
        private GamePanel() {
            ...
            for (int i = 0; i < config.deckSize; ++i){
                String num = intInBaseToPaddedString(i, config.featureCount, config.featureSize);
                deck[i] = loadImageResource("cards/" + num + ".png");
            }
